...
const SideBar = () => {
  ...
  const topMenu = [
    ...
    getItem(<a href="/">생산 계획 수립</a>, '5', <CalendarOutlined />),
    getItem(<a href="/">자재 소요량 산출</a>, '6', <CalendarOutlined />),
  ...
  return (
    <div style={{ backgroundColor: '#fff', borderRight: '1px soild #ccc', padding: '40px 20px 40px 20px', width: '300px', minHeight: '100vh', position: 'absolute', boxSizing: 'border-box', zIndex: '99' }}>
