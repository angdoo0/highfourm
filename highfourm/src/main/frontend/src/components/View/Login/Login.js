        ...
        <Row justify="center" align="middle" style={{ minHeight: '80vh' }}>
          <Col>
            <div style={{ textAlign: 'center', verticalAlign: 'center' }}>
              <div className='top-text'>Welcome to
                <svg width="280" height="60" viewBox="0 0 112 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>High 4M, 생산 관리의 핵심 가치를 반영하는 ERP</div>
              <form method='' action=''>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <div className='modal-div'>
                    <label htmlFor='id' className='login-title'>아이디</label>
                    <InputBar placeholderMsg='아이디' inputId={'id'} id={'id'} required='아이디를 입력해주세요' />
                  </div>
                  <div className='modal-div'>
                      <label htmlFor='password' className='login-title'>비밀번호</label>
                      <InputBar type="password" placeholderMsg='비밀번호' inputId={'password'} id={'password'} required='비밀번호를 입력해주세요' />
                  </div>
